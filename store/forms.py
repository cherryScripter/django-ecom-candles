...
class ChangePasswordForm(SetPasswordForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields[
            'new_password1'].help_text = '<ul class="form-text text-muted small"><li>' \
                                         'Your password can\'t be too similar to your other ' \
                                         'personal information.</li><li>Your password must ' \
                                         'contain at least 8 characters.</li><li>Your password ' \
                                         'can\'t be a commonly used password.</li><li>Your ' \
        ...
        self.fields[
            'new_password2'].help_text = '<span class="form-text text-muted"><small>Enter ' \
                                         'the same password as before, for verification.</small></span>'
...
class UpdateUserForm(UserChangeForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields[
            'username'].help_text = '<span class="form-text text-muted"><small>Required. ' \
